...
ROOT_URLCONF = 'autosmart2.conf.urls.main'
...
WSGI_APPLICATION = 'autosmart2.conf.wsgi.app.application'
...
# Logging
LOG_PATH = os.path.join(VIRTUALENV_DIR, 'var/log/django/autosmart2.log')
...
DEFAULT_FROM_EMAIL = 'admin@autosmart2.com'
